<?php
$functionsdir=dirname(dirname(__FILE__)).'/functions/';
...
$code['root'] = $functionsdir;// full path, with trailing slash ##
if ( $_SESSION['live'] == 0 ) { // running locally ##
    $code['root'] = $functionsdir; // local path -- for testing ##     
} 
$code['domain_cookie'] = ".qdjl.net"; // domain name ##
